            ...
            <div className='flex flex-row' style={{ height: "calc(100vh - 8rem)" }}>
                ...
                <div className='p-8 w-3/4'>
                    ...
                    <div className='w-full mb-3'>
                        ...
                        <input type="text" className='text-xl outline-none border-2 w-[25rem] rounded-md h-[3.5rem] p-2' />
                    </div>
                    <div className='w-full mb-3'>
                    ...
                    <div className='flex flex-row items-end justify-start w-[80%]'>
                        <div className='text-[12px] md:text-base font-medium text-white pt-3 pb-3 pl-6 pr-6 bg-[#696DCA] w-[10rem] rounded-lg  text-center m-2  ml-0'><button>Save changes</button></div>
                        <div className='text-[12px] md:text-base font-medium text-[#3F3D56] pt-3 pb-3 pl-6 pr-6 bg-white border border-[black] w-[10rem]  text-center m-2  rounded-lg ml-8'><button>Cancel</button></div>
                    </div>
                </div>
            </div>
        </div>
