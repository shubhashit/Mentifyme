...
export default function BookCenter() {
    return (
        <div className='flex flex-col items-center p-2'>
            ...
            <div className='text-xs md:text-base font-medium text-white pt-3 pb-3 pl-6 pr-6 bg-[#696DCA] w-[13rem] text-center rounded '><button>Book Your Call Now</button></div>
        </div>
    )
}
