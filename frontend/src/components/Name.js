  ...
  return ( 
      <div>
          ...
          <div className='flex flex-row'>
              <div className='w-20 h-2 ml-6  bg-[#696DCA] rounded-md mr-3 cursor-pointer'></div>
          ...
          <div>
              ...
              <div className='m-6 flex-row flex mt-20 border-b border-[#696DCA] w-[35vw] justify-between items-center'>
                  <input type="text" className='outline-none w-full  text-[#696DCA] text-2xl' placeholder='Enter Your Name Here' />
                  <div><img src={arrowleftsquare} className='cursor-pointer' alt="" /></div>
              </div>
          </div>
          <div className='m-6 w-[50vw] flex flex-row justify-end mt-10 h-12 '>
              <button className='bg-[#696DCA] pr-4 pl-4 pt-1 pb-1 text-lg text-white rounded-sm mr-3 w-1/5 flex flex-row justify-center items-center opacity-50' onClick={() => {navigate("/timetable/MobileNumber")}}>Next <img src={forward} alt="" /></button>
          </div>
      </div>
  )
}
