  ...
  return (
    <div className='p-2 md:flex md:flex-col md:items-center md:pb-0'>
          ...
          <div className='flex flex-row items-center mt-4'>
              <div className='text-xs md:text-base font-medium text-white pt-3 pb-3 pl-6 pr-6 bg-[#696DCA] w-[13rem] text-center m-2 rounded '><button>Book Your Call Now</button></div>
