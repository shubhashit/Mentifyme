...
export default function Benifits() {
    return (
        <div className='bg-[#222222] text-white flex flex-col justify-center items-center' >
            <div className='text-4xl font-semibold text-white'>Unlock exclusive benefits from <span className='text-[#696DCA]'> Mentifyme</span></div>
            <div className='text-lg font-semibold text-white'>Learn from the Guidance of mentor from top IITs/AIIMS</div>
            <div className='flex flex-row items-center w-full justify-between'>
                <div><img src={one} className='m-3 w-24 ml-6' alt="" /></div>
                <div>
                    ...
                    <div className='mt-4'><button className='bg-[#696DCA] pr-5 pl-5 pt-2 pb-2 text-2xl text-white rounded-md mr-3 flex flex-row relative'>Create for free </button></div>
                </div>
                <div><img src={onepic} className='w-80' alt="" /></div>
            </div>
            <div className='flex flex-row-reverse items-center w-full justify-between mt-16 mb-16'>
                <div><img src={two} className='m-3 w-24 mr-6' alt="" /></div>
                <div>
                    <div className='text-2xl font-semibold text-white mb-2'><span className='text-[#696DCA]'>Personalised</span> Study Plan</div>
                    ...
                    <div className='flex flex-row items-center mb-2'><img src={handArrow} className='mr-3' alt="" /></div>
                    ...
                    <div className='mt-4'><button className='bg-[#696DCA] pr-5 pl-5 pt-2 pb-2 text-2xl text-white rounded-md mr-3 flex flex-row relative'>Talk Now @99 only</button></div>
                </div>
                <div><img src={twopic} className='w-80' alt="" /></div>
            </div>
