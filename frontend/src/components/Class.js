...
export default function Class() {
    ...
    return (
        <div>
            ...
            <div>
                <div className='m-6 '>
                    <div className='text-2xl font-bold'>Select in which class are you?</div>
                ...
                <div className='m-6 flex flex-row items-center'>
                    ...
                    <div className='text-2xl '>11th</div>
                </div>
                <div className='m-6 flex flex-row items-center'>
                    <div className='border border-black h-6 w-6 rounded-full mr-4'></div>
                    <div className='text-2xl '>12th</div>
                </div>
                <div className='m-6 flex flex-row items-center'>
                    <div className='border border-black h-6 w-6 rounded-full mr-4'></div>
                    <div className='text-2xl '>Dropper</div>
                </div>
            </div>
            <div className='m-6 w-[50vw] flex flex-row justify-between mt-10 h-12 '>
                <button className='bg-[#696DCA] pr-4 pl-4 pt-1 pb-1 text-lg text-white rounded-sm mr-3 w-1/5 flex flex-row items-center' onClick={() => { navigate("/timetable/ExamType")}}> <img src={back} alt="" /> Previours</button>
                <button className='bg-[#696DCA] pr-4 pl-4 pt-1 pb-1 text-lg text-white rounded-sm mr-3 w-1/5 flex flex-row justify-center items-center opacity-50' onClick={() => { navigate("/timetable/CoachingName") }}>Next <img src={forward} alt="" /></button>
            </div>
        </div>
    )
}
