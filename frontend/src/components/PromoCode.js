...
export default function PromoCode() {
    return (
        <div className='relative flex flex-col items-center justify-between pt-24'>
            ...
            <div className='w-[90%]  rounded mt-8 relative mb-8  flex flex-col items-center justify-between border p-12 h-[50vh]' style={{ "boxShadow": "0px 0px 4px 0px rgba(0, 0, 0, 0.25)" }}>
                ...
                <div className='flex flex-row justify-between items-center'>
                    <input type='text' className='h-16 w-[33rem] mr-4 rounded-lg border pl-4 text-xl  outline-none placeholder:text-[#878787]' placeholder='Have a promo code?'></input>
                    <div className='text-[#878787] text-xl font-medium'>APPLY NOW</div>
                </div>
            </div>
            <div className='w-[24rem] p-4 text-base font-medium bg-[#696DCA] rounded text-[white] flex justify-center items-center mr-2'>Proceed to Payment</div>
        </div>
    )
}
