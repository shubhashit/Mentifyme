...
export default function CoachingName() {
    ...
    return (
        <div>
            ...
            <div>
                <div className='m-6 '>
                    <div className='text-2xl font-bold'>Name of Your Coaching</div>
                    <div className='flex flex-row'>
                        <input type="checkbox" className='mr-2 border-[#898989] cursor-pointer' />
                        <div className='text-lg text-[#898989]'>Select this if you don't go to coaching</div>
                    </div>
                </div>
                <div className='m-6 flex-row flex mt-20 border-b border-[#696DCA] w-[40vw] justify-between items-center'>
                    <input type="text" className='outline-none w-full  text-[#696DCA] text-2xl' placeholder='Enter Your Coaching Name ' />
