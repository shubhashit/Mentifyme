...
export default function Payment() {
  ...
  return (
    <div className='mb-4'>
      ...
      {section == 3 ? <PromoCode OnPrevious={OnPrevious} setsection={setsection} paymentSequence={paymentSequence} dateTimeDetails={dateTimeDetails} personaldetails={personaldetails} ></PromoCode> : <></>}
    </div>
  )
}
